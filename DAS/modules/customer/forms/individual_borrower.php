...
// Set page title
$pageTitle = 'Individual Borrower Form';

// Include Header
include __DIR__ . '/shared/form_header.php';

// Ensure $borrower_data is available (passed from form_router.php or parent)
...
<form id="borrowerForm" class="needs-validation" novalidate>
    <input type="hidden" name="borrower_type" value="Individual">
    <?php if ($borrower_id): ?>
    ...
    <div class="card border-0 shadow-sm mb-3" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);">
        <div class="card-body p-3">
            <div class="d-flex align-items-center justify-content-between">
                ...
                <a href="../pages/person_selector.php?form=borrower&profile_id=<?php echo $profile_id; ?>&customer_type=Individual" 
            ...
            <div class="card-body p-4">
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" name="full_name_en" value="<?php echo $borrower_data['full_name_en'] ?? $borrower_data['full_name'] ?? ''; ?>" required oninput="document.getElementById('hidden_full_name').value = this.value">
                        <input type="hidden" name="full_name" id="hidden_full_name" value="<?php echo $borrower_data['full_name'] ?? ''; ?>">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Full Name (Nepali) / पूरा नाम (नेपाली)</label>
                        <input type="text" class="form-control nepali-input" name="full_name_np" value="<?php echo $borrower_data['full_name_np'] ?? ''; ?>" placeholder="पूरा नाम">
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">लिङ्ग <span class="text-danger">*</span></label>
                        <select class="form-select" name="gender" required>
                            <option value="">छान्नुहोस्</option>
                            <option value="Male" <?php echo ($borrower_data['gender'] ?? '') == 'Male' ? 'selected' : ''; ?>>पुरुष</option>
                            <option value="Female" <?php echo ($borrower_data['gender'] ?? '') == 'Female' ? 'selected' : ''; ?>>महिला</option>
                            <option value="Other" <?php echo ($borrower_data['gender'] ?? '') == 'Other' ? 'selected' : ''; ?>>अन्य</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">वैवाहिक स्थिति</label>
                        <select class="form-select" name="relationship_status">
                            <option value="">छान्नुहोस्</option>
                            <option value="Single" <?php echo ($borrower_data['relationship_status'] ?? '') == 'Single' ? 'selected' : ''; ?>>अविवाहित</option>
                            <option value="Married" <?php echo ($borrower_data['relationship_status'] ?? '') == 'Married' ? 'selected' : ''; ?>>विवाहित</option>
                            <option value="Divorced" <?php echo ($borrower_data['relationship_status'] ?? '') == 'Divorced' ? 'selected' : ''; ?>>सम्बन्ध विच्छेद</option>
                            <option value="Widowed" <?php echo ($borrower_data['relationship_status'] ?? '') == 'Widowed' ? 'selected' : ''; ?>>विधवा/विधुर</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Date of Birth (BS) / जन्म मिति <span class="text-danger">*</span></label>
                        <input type="text" class="form-control nepali-date-picker" id="date_of_birth" name="date_of_birth" placeholder="YYYY-MM-DD" value="<?php echo $borrower_data['date_of_birth'] ?? ''; ?>" required>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">Citizenship No / नागरिकता नं <span class="text-danger">*</span></label>
                        <input type="text" class="form-control nepali-input" name="citizenship_number" value="<?php echo $borrower_data['citizenship_number'] ?? ''; ?>" required>
                    </div>

                    <div class="col-md-3">
                        <label class="form-label fw-semibold">ID Issue Date (BS) / जारी मिति</label>
                        <input type="text" class="form-control nepali-date-picker" name="id_issue_date" placeholder="YYYY-MM-DD" value="<?php echo $borrower_data['id_issue_date'] ?? ''; ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control nepali-input" name="id_issue_district" value="<?php echo $borrower_data['id_issue_district'] ?? ''; ?>">
                    </div>
                    <div class="col-md-3">
                        ...
                        <select class="form-select" name="id_issue_authority">
                            <option value="">छान्नुहोस्</option>
                            <option value="जिल्ला प्रशासन कार्यालय" <?php echo ($borrower_data['id_issue_authority'] ?? '') == 'जिल्ला प्रशासन कार्यालय' ? 'selected' : ''; ?>>जिल्ला प्रशासन कार्यालय</option>
                            <option value="इलाका प्रशासन कार्यालय" <?php echo ($borrower_data['id_issue_authority'] ?? '') == 'इलाका प्रशासन कार्यालय' ? 'selected' : ''; ?>>इलाका प्रशासन कार्यालय</option>
                        </select>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">CTZ Reissued / नागरिकता पुनः जारी</label>
                        <div class="form-check mt-2">
                            <input class="form-check-input" type="checkbox" id="ctz_reissued" name="ctz_reissued" value="1" <?php echo ($borrower_data['ctz_reissued'] ?? 0) == 1 ? 'checked' : ''; ?> onchange="toggleReissueFields()">
                            <label class="form-check-label" for="ctz_reissued">
                                नागरिकता पुनः जारी गरिनुहोस्
                            </label>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">पुनः जारी मिति (BS)</label>
                        <input type="text" class="form-control nepali-date-picker" id="id_reissue_date" name="id_reissue_date" value="<?php echo $borrower_data['id_reissue_date'] ?? ''; ?>" disabled>
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3">
                        <label class="form-label fw-semibold">  पुनः जारी पटक</label>
                        <select class="form-select" id="reissue_count" name="reissue_count" disabled>
                            <option value="0" <?php echo ($borrower_data['reissue_count'] ?? 0) == 0 ? 'selected' : ''; ?>>पहिलो पटक</option>
                            <option value="1" <?php echo ($borrower_data['reissue_count'] ?? 0) == 1 ? 'selected' : ''; ?>>पहिलो पुनः जारी</option>
                            <option value="2" <?php echo ($borrower_data['reissue_count'] ?? 0) == 2 ? 'selected' : ''; ?>>दोस्रो पुनः जारी</option>
                            <option value="3" <?php echo ($borrower_data['reissue_count'] ?? 0) == 3 ? 'selected' : ''; ?>>तेस्रो पुनः जारी</option>
                        </select>
                    </div>
                </div>
                <div class="mt-4">
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-body p-4">
                <div id="familyContainer">
                    ...
                    <!-- Existing family members will be loaded here via JS or PHP loop -->
                    <div class="dynamic-row row g-3 mb-3">
                        <div class="col-md-5">
                            <label class="form-label fw-semibold">Name / नाम</label>
                            <input type="text" class="form-control nepali-input" name="family_name[]" placeholder="नाम">
                        </div>
                        <div class="col-md-5">
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    <?php if ($borrower_id && !empty($borrower_data)): ?>
    // Permanent Address
    const permProvince = '<?php echo $borrower_data['perm_province'] ?? ''; ?>';
    const permDistrict = '<?php echo $borrower_data['perm_district'] ?? ''; ?>';
    const permMunicipality = '<?php echo $borrower_data['perm_municipality_vdc'] ?? ''; ?>';
    const permWard = '<?php echo $borrower_data['perm_ward_no'] ?? ''; ?>';
    ...
    // Temporary Address
    const tempProvince = '<?php echo $borrower_data['temp_province'] ?? ''; ?>';
    const tempDistrict = '<?php echo $borrower_data['temp_district'] ?? ''; ?>';
    const tempMunicipality = '<?php echo $borrower_data['temp_municipality_vdc'] ?? ''; ?>';
    const tempWard = '<?php echo $borrower_data['temp_ward_no'] ?? ''; ?>';
    ...
    <?php if ($borrower_id): ?>
    fetch('../../api/customer_api.php?action=get_family_details&person_id=<?php echo $borrower_id; ?>&person_type=Borrower')
...
document.getElementById('borrowerForm').addEventListener('submit', function(e) {
    ...
    // Sometimes dynamically added fields might be missed by global iterator if timing is off
    ...
    familyInputs.forEach(input => {
        if (input.value && typeof PreetiConverterCore !== 'undefined') {
            // Force convert if not unicode
            // Simple check: if it has no unicode chars, assume it needs conversion
            ...
            if (!hasUnicode) {
                try {
                     ...
                     input.style.fontFamily = ''; // Reset font
...
<?php include __DIR__ . '/borrower_autofill.php'; ?>
